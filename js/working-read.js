document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderPDF(file) {
        ...
        reader.appendChild(objectElement);

        // Adjust height of the reader div after the PDF is loaded
        objectElement.onload = function() {
            const pdfHeight = objectElement.contentDocument.documentElement.scrollHeight;
            reader.style.height = `${pdfHeight}px`;
            startTracking();
        };
    }
