document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        console.log('Failed to initialize PDF viewer. Please refresh the page.');
    }
});
...
//                 // Calculate scale based on the reader dimensions and the width multiplier
//                 const scaleWidth = ((readerWidth) / viewport.width);
//                 const scaleHeight = readerHeight / viewport.height;
...
//                 // Set the canvas dimensions, using the device pixel ratio
//                 canvas.height = scaledViewport.height;
//                 canvas.width = scaledViewport.width;
